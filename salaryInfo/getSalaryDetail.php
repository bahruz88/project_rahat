...
from $tbl_salary_info e
  ...
  LEFT join $tbl_place_expenditure tpe on tpe.id=e.place_expenditure_id
LEFT join $tbl_position_status tps on tps.id=e.position_status_id
LEFT join $tbl_reward_period trp on trp.id=e.reward_period
