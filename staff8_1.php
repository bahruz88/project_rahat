            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-content" style=" box-shadow: 0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24)">
                        ...
                        <div id="editor"></div>
                        <p>Struktur bölmələrin adı və vəzifələr</p>
                        <button onclick="generate('staff')">Create PDF</button>
                    </div>
                </div>
    ...
    $("#enterprise_name").change(function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                //     return value != "enterprise_head_fullname";
                // });
                // data1 = jQuery.grep(data1, function(value) {
                ...
                // });
                // data1 = jQuery.grep(data1, function(value) {
                //     return value != "company_tel";
                // });
                // data1.remove("company_tel");
                // data1.splice($.inArray("company_tel", data1), 1);
                // console.log('dataaaaaaa1=' , data1)
