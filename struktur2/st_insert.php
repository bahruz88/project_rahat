...
if($pId==0 or $pId=='' or $pId=='null'){
    $sql = "INSERT INTO $tbl_employee_category( 
	 id, parent, category,icon,code,emp_id,structure_level,position_level,create_date) 
	 VALUES (NULL, NULL,'$name','$icon','$code','$emp_id','$structure_level','$position_level','$create_date')";

}else{
    $sql = "INSERT INTO $tbl_employee_category( 
	 id, parent, category,icon,code,emp_id,structure_level,position_level,create_date) 
	 VALUES (NULL, '$pId','$name','$icon','$code','$emp_id','$structure_level','$position_level','$create_date')";
