...
console.log('content=',content)
            ...
            //  var outdocx=doc.getZip().generate({
            //     type:"docx",
            //     mimeType: "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
            // }) //Output the document using Data-URI
            //
            // console.log('outdocx=',outdocx)
            docPdf.fromHTML(`<html><head><title>sss</title>`);
            docPdf.fromHTML(`<link rel="stylesheet" type="text/css" href="css/bootstrap.min.css" >
  <link rel="stylesheet" type="text/css" href="css/bootstrap-select.min.css">
             <link rel="stylesheet" href="plugins/fontawesome-free/css/all.min.css">
             <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
             <link rel="stylesheet" href="plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
             ...
             <link rel="stylesheet" href="dist/css/adminlte.min.css">
<link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">`);
            docPdf.fromHTML(`</head><body> <iframe src = "senedler/emek2.pdf" width='700' height='550' allowfullscreen webkitallowfullscreen></iframe>
       </body></html>`);
            ...
            // docPdf.addHTML(element, function () {
            //     var blob = docPdf.output('blob');
            // });
            // window.open(blobUrl, '_blank')
            // window.open('data:application/pdf;base64,' + outbase64);
            // var valueFile = 'data:application/octet-stream;base64,' + outbase64;
            // var dlnk = $('#dwnldLnkPDF5')[0];
            // dlnk.href = valueFile;
            // dlnk.click();
 // console.log('out=',out)
            docPdf.save('div.pdf');

            // let textFile = window.URL.createObjectURL(out);
            // let window2 = window.open(textFile, 'log.' + new Date() + '.pdf');
            // window2.onload = e => window.URL.revokeObjectURL(textFile);
            // saveAs(out,"output.docx")

            // saveDatabaseBlob (out)
            // const blob = new Blob(out, {type: 'application/pdf'});
            // const blobURL = URL.createObjectURL(blob);
            // window.open(blobURL)
            window.saveAs(out, 'downloaded.pdf');
