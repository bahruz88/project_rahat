					...
					<div class="card-body" style="position: relative; overflow: auto; height: 500px;overflow-y: scroll; ">
						 ...
						 <div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
						<select   data-live-search="true" name="tm_type_name" title="<?php echo $dil["selectone"];?>" class="form-control selectpicker"  placeholder="<?php echo $dil["tm_type"];?>" >
								 	<?php 
									 $result_tm_type = $db->query($sql_tm_type);
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
						<select   data-live-search="true" name="sch_type_name" title="<?php echo $dil["selectone"];?>" class="form-control selectpicker"  placeholder="<?php echo $dil["sch_type"];?>" >
								 	<?php 
									 $result_sch_type = $db->query($sql_sch_type);
        ...
        <div class="modal-body"  >
                ...
                <table class="table table-condensed table-bordered" style="width:100% ;">
                  ...
                  <tbody>
                    <tr>
                      <td><b>B.E</b></td>
                      <td style="width:30px;"><input type="text" class="form-control schgrid" id="start_time_id" name="start_time_name" placeholder="Başlama" /></td>
                      <td style="width:30px;"><input type="text" class="form-control schgrid" id="end_time_id" name="end_time_name" placeholder="Bitmə" /></td>
                      <td style="width:30px;"><input type="text" class="form-control schgrid" id="start_time_id" name="start_time_name" placeholder="Başlama" /></td>
                      <td style="width:30px;"><input type="text" class="form-control schgrid" id="end_time_id" name="end_time_name" placeholder="Bitmə" /></td>
                      <td style="width:30px;"><input type="text" class="form-control schgrid" id="start_time_id" name="start_time_name" placeholder="Başlama" /></td>
                      <td style="width:30px;"><input type="text" class="form-control schgrid" id="end_time_id" name="end_time_name" placeholder="Bitmə" /></td>
 				...
 				<td>
				 <input type="checkbox" name="my-checkbox" checked data-switch="false" data-bootstrap-switch data-off-color="danger" data-on-color="success">
				</td>
