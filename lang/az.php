...
$dil = array(
    ...
    "empty_directorate" 	=>"Direktorluğu  boş qoymaq olmaz",
    "empty_department" 	=>"Departamenti  boş qoymaq olmaz",
    "empty_depart" 	=>"Şöbəni  boş qoymaq olmaz",
    "empty_area_section" 	=>"Sahə / Bölməni  boş qoymaq olmaz",
    "empty_position" 	=>"Vəzifəsini  boş qoymaq olmaz",
    "empty_position_level" 	=>"Pozisya səviyyəsini  boş qoymaq olmaz",
    "empty_status" 	=>"Statusunu  boş qoymaq olmaz",
    "empty_employment_contract_indefinite" 	=>"İşçini  boş qoymaq olmaz",
    "empty_probation" 	=>"Əmək müqaviləsi müddətsizdirmi-ni  boş qoymaq olmaz",
    "empty_dates" 	=>"Sınaq müddətini  boş qoymaq olmaz",
    "empty_trial_expiration_date" 	=>"Sınaq müddətinin bitmə tarixini  boş qoymaq olmaz",
    "empty_employee_start_date" 	=>"İşçinin işə başlama tarixini  boş qoymaq olmaz",
    "empty_date_conclusion_employment_contract" 	=>"Əmək müqaviləsinin bağlanma tarixini  boş qoymaq olmaz",
    "empty_regulation_property_relations" 	=>"Mülkiyyət münasibətlərinin tənzimlənməsini  boş qoymaq olmaz",
    "empty_termination_cases" 	=>"Əmək müqaviləsinə xitam verilməsi barədə tərəflərin müəyyən etdiyi hallarını  boş qoymaq olmaz",
    "empty_other_conditions_wages" 	=>"Tərəflərin əmək haqqının ödənilməsi barədə razılığa gəldikləri digər şərtlərini  boş qoymaq olmaz",
    "empty_workplace_status" 	=>"İş yerinin statusunu  boş qoymaq olmaz",
    "empty_working_conditions" 	=>"Əmək şaraitini  boş qoymaq olmaz",
