...
$sql_employees = "select  id, concat(lastname,' ', firstname ,' ', surname) full_name , emp_status,empno,image_name from $tbl_employees  where emp_status=1 and company_id='$company_id'";
