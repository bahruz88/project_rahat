...
$sql = "INSERT INTO $tbl_schedules (
		  id, 		 sch_name,   sch_code,         company_id,             start_date, 			   expire_date,          sch_type,         night_time,  insert_user ) 
VALUES (NULL, '$schname_name', '$schcode', '$company_id_name', '$sch_start_date_name', '$sch_expire_date_name',  '$sch_type_name',  '$night_time_name',       '$uid') ";
